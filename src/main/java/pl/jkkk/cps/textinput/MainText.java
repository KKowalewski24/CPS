...
public class MainText {
    ...
    private static Signal generate(String[] args) {
        ...
        case SINUSOIDAL_SIGNAL:
            return new SinusoidalSignal(Double.parseDouble(args[2]), Double.parseDouble(args[3]),
                    Double.parseDouble(args[4]), Double.parseDouble(args[5]));
        case SINUSOIDAL_RECTIFIED_ONE_HALF_SIGNAL:
            return new SinusoidalRectifiedOneHalfSignal(Double.parseDouble(args[2]), Double.parseDouble(args[3]),
                    Double.parseDouble(args[4]), Double.parseDouble(args[5]));
        case SINUSOIDAL_RECTIFIED_IN_TWO_HALVES:
            return new SinusoidalRectifiedTwoHalfSignal(Double.parseDouble(args[2]), Double.parseDouble(args[3]),
                    Double.parseDouble(args[4]), Double.parseDouble(args[5]));
        case RECTANGULAR_SIGNAL:
            return new RectangularSignal(Double.parseDouble(args[2]), Double.parseDouble(args[3]),
                    Double.parseDouble(args[4]), Double.parseDouble(args[5]), Double.parseDouble(args[6]));
        case SYMMETRICAL_RECTANGULAR_SIGNAL:
            return new RectangularSymmetricSignal(Double.parseDouble(args[2]), Double.parseDouble(args[3]),
                    Double.parseDouble(args[4]), Double.parseDouble(args[5]), Double.parseDouble(args[6]));
        case TRIANGULAR_SIGNAL:
            return new TriangularSignal(Double.parseDouble(args[2]), Double.parseDouble(args[3]),
                    Double.parseDouble(args[4]), Double.parseDouble(args[5]), Double.parseDouble(args[6]));
        case UNIT_JUMP:
            return new UnitJumpSignal(Double.parseDouble(args[2]), Double.parseDouble(args[3]),
                    Double.parseDouble(args[4]), Double.parseDouble(args[5]));
        case UNIT_IMPULSE:
            return new UnitImpulseSignal(Double.parseDouble(args[2]), Double.parseDouble(args[3]),
